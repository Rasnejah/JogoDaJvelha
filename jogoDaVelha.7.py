...
def PreencherTabela(posicao, ganhador):
	print(ganhador)
	if ganhador == 'ganhadorA' or ganhador == 'ganhadorB':
			ZeraTabela(tabela)
	posicaoL = posicao[0]
	posicaoC = posicao[1]	
...
def ZeraTabela(tabela):
	tabela =	'tabela zerada'
...
while True:
	ganhador = VerificarGanhador(tabela)
	print('gadfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfd',ganhador)
	user = input('posição :')	
	if user == 0:
		break
	else:
		...
		print(tabela)
		PreencherTabela(posicao, ganhador)
